...
<section class="content-index mt-3">
    <div class="container">
        ...
        <div class="colaboradores hb-mt-50">
            <h3 class="hb-txt-secondary hb-w-700 mb-4 text-center">
                Colaboradores
            </h3>
            <div class="row">
                <div class="col-md-3 col-sm-12 mt-3 mb-3">
                    ...
                    <div class="text-center mt-4">
                        <h4 class="hb-txt-secondary hb-w-700 pb-2">
                            João Neto
                        </h4>
                ...
                <div class="col-md-3 col-sm-12 mt-3 mb-3">
                    <img src="assets/images/joao.png">
                    <div class="text-center mt-4">
                        <h4 class="hb-txt-secondary hb-w-700 pb-1">
                            Phelipe Macel
                        </h4>
                        <p class="hb-txt-white hb-w-400 hb-no-margin">
